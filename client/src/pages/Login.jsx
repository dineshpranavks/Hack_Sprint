...
export default function Login() {
  ...
  // Target path user attempted to visit
    ...
    <div className="auth-page grid-bg">
      ...
      <div className="auth-card fade-up">
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Sign in to access AI-powered interview search & solutions</p>
        </div>
        ...
        {resetMessage && (
          <div className="auth-alert auth-alert--success fade-in">
